const CACHE="foldrone-play-v0.4.9-final-welcome-tone";
const CORE=["./","./index.html","./styles.css","./app.js","./manifest.webmanifest","./header-logo-new.png","./foldrone-play-mark.png","./foldrone-welcome-tone.mp3"];
