const CACHE="foldrone-play-v0.4.3";
const CORE=["./","./index.html","./styles.css","./app.js","./manifest.webmanifest","./foldrone-play-logo.svg","./preparing-media.jpg","./homepage-art.jpg"];
